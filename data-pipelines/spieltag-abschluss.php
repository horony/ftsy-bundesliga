...
$aktueller_spieltag_type = mysqli_query($con, "
    ...
    WHERE
        buli_round_name = (SELECT spieltag FROM xa7580_db1.parameter) 
...
mysqli_query($con, "
    ...
    WHERE 
        ( round_name = '".$aktueller_spieltag."' AND season_id = '".$akt_season_id."' ) 
...
$shellcommand = escapeshellcmd('./topxi.py');
