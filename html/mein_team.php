        ...
        <div id="content_wrapper">
            <div id="headline_wrapper">
                <?php 
                    ...
                    $team_info = mysqli_query($con, "	
                        ...
                        LEFT JOIN xa7580_db1.ftsy_tabelle_2020 opp 
                            ON  opp.season_id = (SELECT season_id FROM xa7580_db1.parameter)
                            ...
                            AND ( CASE WHEN sch.ftsy_home_id = tab.player_id THEN sch.ftsy_away_id ELSE sch.ftsy_home_id END ) = opp.player_id
                ...
                <div id="top_wrapper">
                    ...
                    <?php
                        if (!empty($team_info_array['user_id'])) {
                            ...
                            $team_image_src = isset($team_images[$user_id]) ? $team_images[$user_id] : '';

                            if (!empty($team_image_src)) {
                        ...
                        <div id="trophy_case" class="trophy_case_right">
                            ...
                            <?php
                                ...
                                while ($season_data = $result_season->fetch_object()) {
                                    ...
                                    if ($season_name) {
                                        $titles_found = true;
                                        echo "<div class='trophy_item'><div class='trophy_icon'><span>🏅</span></div><div class='trophy_title'>Meister:<br> " . htmlspecialchars($season_name) . "</div></div>";
                                    }
                                }

                                if (!$titles_found) {
                                    echo "<div class='trophy_item'><div class='trophy_icon'><span class='greyed-out'>🏅</span></div><div class='trophy_title'>Keine<br> Meistertitel</div></div>";
                                }
                        ...
                        <div id="trophy_case" class="trophy_case_right">
                            ...
                            <?php
                                ...
                                while ($season_data = $result_season->fetch_object()) {
                                    ...
                                    if ($season_name) {
                                        $titles_found = true;
                                        echo "<div class='trophy_item'><div class='trophy_icon'><span>🏆</span></div><div class='trophy_title'>Pokalsieger: " . htmlspecialchars($season_name) . "</div></div>";
                                    }
                                }

                                if (!$titles_found) {
                                    echo "<div class='trophy_item'><div class='trophy_icon'><span class='greyed-out'>🏆</span></div><div class='trophy_title'>Keine Pokale</div></div>";
                                }
                            ?>
