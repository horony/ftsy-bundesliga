    ...
    <div id="content_wrapper">
        <div id="headline_wrapper">
            ...
            <div id="team_wrapper">
                <div id="view_nav">
                    <ul>
                        <li><a id="button_show_grafisch" onclick="showGraphic(); changeColorGraphic()">FORMATION</a></li>
                        <li><a id="button_show_tabelle" onclick="showTable(); changeColorTable()">DETAIL</a></li>
                    </ul>
                </div>
                ...
                <div id="aufstellung_wrapper"></div>
            </div>
        </div>
    </div> 
</body>
