...
<div id = "hilfscontainer">
    ...
    <!-- Content -->
    <main>
    <div class = "content_container"> <!-- content_container start -->

        <div class = "outer_container_headline">
            <h2>TRANSFERMARKT</h2>
        </div>
            ...
            <div class="row_outer">
                ...
                <div id = "free_agent" class="col">
                    ...
                    echo "<div class='kader row'><table id='myTable' border='0'>
                        <tr>
                            <th></th>
                            <th class='table_col_player' title='Spieler'>Spieler</th>
                            <th class='table_col_position' title='Fantasy-Position' onclick='sortTable(3)' align='center' style='cursor: pointer;'>Pos</th>				
                            <th class='table_col_matchup' title='Matchup aktueller Spieltag'>Matchup</th>
                            <th class='table_col_scr' title='Gesamte Fantasy-Punkte über die Saison' onclick='sortTable(5)' align='center' style='cursor: pointer;'>&udarr; Saison</th>
                            <th class='table_col_scr' title='Durchschnittliche Fantasy-Punkte über die Saison' onclick='sortTable(6)' align='center' style='cursor: pointer;'>&udarr; Avg</th>
                            <th class='table_col_scr' title='Fantasy-Punkte letzter Spieltag' onclick='sortTable(7)' align='center' style='cursor: pointer;'>&udarr; Last</th>
                            <th class='table_col_scr' title='Projection aktueller Spieltag' onclick='sortTable(8)' align='center' style='cursor: pointer;'>&udarr; Proj</th>					
                            <th class='table_col_fitness' title='Fitness'>Status</th>
                            <th class='table_col_owner' title='Aktueller Besitzer des Spielers' onclick='sortTable(9)' style='cursor: pointer;'>Besitzer</th>
                            <th class='table_col_checkbox'>Add</th>
                        </tr>";
                        ...
                        while($row = mysqli_fetch_array($result_ava)) {
                            ...
                            echo "<tr class='" . $owner_class . " " . $filter_class." ".$filter_own. "'>";
                                ...
                                echo "<td class='table_col_team' title='Verein'><img height='15px' width='auto' src='" . $row['verein_logo'] . "'></td>";
                                echo "<td class='table_col_player' title='Spieler'><a href='" . $link_datenbank . "'>" . mb_convert_encoding($row['name'], 'UTF-8') . "</a></td>";
                                echo "<td class='table_col_position' title='Fantasy-Position'>" . $row['pos'] . "</td>";
                                echo "<td class='table_col_matchup' title='".$matchup_expl."'><span style= color:".$opp_color.";'>  vs. " . mb_convert_encoding($row['opp_code'], 'UTF-8') . "</span></td>";			
                                echo "<td class='table_col_scr' title='Gesamte Fantasy-Punkte über die Saison'>" . $row['total_fb_score'] . "</td>";
                                echo "<td class='table_col_scr' title='Durchschnittliche Fantasy-Punkte über die Saison'>" . $row['avg_fb_score'] . "</td>";
                                ...
                                echo "<td class='table_col_fitness'>"; 
                                    echo "<img title='" . $row['sidelined_reason'] . "' height='15px' width='auto' src='../img/icons/" . $row['player_status_logo_path'] . "'>";
                                echo "</td>";
                                echo "<td class='table_col_owner'>";
                                echo $row['Besitzer'];
                                echo "</td>";
                                echo "<td class='table_col_checkbox'><input type='checkbox' class='check1'></td>";
                            echo "</tr>";
                            }
                    echo "</table></div>";
                    $stmt_ava->close();
                ...
                <!-- Right column: Players owned by the user -->
