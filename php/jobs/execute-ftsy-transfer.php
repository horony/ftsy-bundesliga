...
if ($Aufzunehmender_Spieler_ID == 0 OR $Abzugebender_Spieler_ID == 0){
    ...
    $aktueller_spieltag = $param_row->spieltag;
        ...
        if ($Aufzunehmender_Spieler_Besitzer == 'FA'){
            ...
            if ($Abzugebender_Spieler_Time <= date('Y-m-d H:i:s')) {
                ...
                mysqli_query($con ,"
                    ...
                    SET
                        ".$ftsy_owner_type_column." = 'USR'
                        , ".$ftsy_owner_id_column." = '".$user_id."'
                        , ".$ftsy_match_status_column." = 'NONE' 
                    WHERE
                        player_id = '$Aufzunehmender_Spieler_ID' 
                ...
                mysqli_query($con ,"
                    UPDATE xa7580_db1.ftsy_player_ownership 
                    SET 
                        ".$ftsy_owner_type_column." = 'WVR'
                        , ".$ftsy_owner_id_column." = NULL
                        , ".$ftsy_match_status_column." = NULL 
                    WHERE 
                        player_id = '$Abzugebender_Spieler_ID' 
                ...
                mysqli_query($con ,"
                    ...
                    WHERE
                        waiver_drop_id = '$Abzugebender_Spieler_ID' 
                        AND owner = '".$user_id."'
                    ");
                ...
                mysqli_query($con ,"
                    ...
                    WHERE 
                        ( rec_trade_id = '$Abzugebender_Spieler_ID' or ini_trade_id = '$Aufzunehmender_Spieler_ID' )
...
EOT;
        ...
        /****************/
            ...
            mysqli_query($con, "
                INSERT INTO xa7580_db1.trade (ID, initiator, recipient, ini_trade_id, rec_trade_id, ini_player_name, rec_player_name)
        ...
        /****************/
            ...
            mysqli_query($con, "
                INSERT INTO xa7580_db1.waiver (prio, ID, owner, waiver_add_id, waiver_drop_id, waiver_add_name, waiver_drop_name)
