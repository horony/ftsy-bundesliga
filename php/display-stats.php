...
if ($stat_category == 'FANTASY-TEAMS'){
    ...
    $topscores = mysqli_query($con,"    
        SELECT  
            'Top 20-Spieltags-Performances seit 2020/2021' as headline 
    ...
    $tabelle = mysqli_query($con,"  
        SELECT 
            'Ewige Tabelle seit 2018/2019' as headline 
            , user_id as besitzer 
    ...
    $meister = mysqli_query($con,"
        SELECT 
            'Fantasy-Bundesliga Meister seit 2018/2019' as headline 
    ...
    $pokal = mysqli_query($con,"
        SELECT  
            'Fantasy-Bundesliga Pokalsieger seit 2020/2021' as headline 
    ...
    $starter = mysqli_query($con,"
        SELECT  
            'Verschiedene Spieler aufgestellt (Liga)' as headline
    ...
    $nicht_gespielt = mysqli_query($con,"   
        SELECT  
            'Nicht eingesetzte Spieler aufgestellt (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $minutes = mysqli_query($con,"  
        SELECT  
            'Spielminuten aufgestellter Spieler (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $tore = mysqli_query($con," 
        SELECT  
            'Fantasy-Punkte aus Toren (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $vorlagen = mysqli_query($con," 
        SELECT  
            'Fantasy-Punkte aus Assists (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $redcard = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus Platzverweisen (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $dribbling = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus Dribbling-Versuchen (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $duelle = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus Duellen (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $schuesse = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus Torschüssen (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $flanken = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus Flanken (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $paesse = mysqli_query($con,"   
        SELECT  
            'Fantasy-Punkte aus Pässen (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $blocks = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus Blocks (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $clear = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus geklärten Bällen (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $dis = mysqli_query($con,"
        SELECT  
            'Fantasy-Punkte aus Ballverlusten (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $ints = mysqli_query($con," 
        SELECT  
            'Fantasy-Punkte aus abgefangenen Bällen (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $tackles = mysqli_query($con,"  
        SELECT  
            'Fantasy-Punkte aus Tacklings (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $torwart = mysqli_query($con,"  
        SELECT  
            'Fantasy-Punkte aus Torwarspiel (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
    ...
    $abschluesse = mysqli_query($con,"  
        SELECT  
            'Fantasy-Punkte aus Abschlüssen gesamt (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
            , sum(
    ...
    $passspiel = mysqli_query($con,"    
        SELECT  
            'Fantasy-Punkte aus Passpiel gesamt (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
            , sum(
    ...
    $zweikampf = mysqli_query($con,"    
        SELECT  
            'Fantasy-Punkte aus Zweikämpfen gesamt (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
            , sum(
    ...
    $gegentore = mysqli_query($con,"    
        SELECT  
            'Fantasy-Punkte aus Gegentoren (Liga)' as headline
            , hist.1_ftsy_owner_id as besitzer
            , user.teamname
            , sum(
    ...
    $fantasy_score_allowed_tw = mysqli_query($con," 
        SELECT  
            'Avg. zugelassene Fantasy-Punkte: Tor' as headline
            , team_name as verein
    ...
    $fantasy_score_allowed_aw = mysqli_query($con," 
        SELECT  
            'Avg. zugelassene Fantasy-Punkte: Abwehr' as headline
            , team_name as verein
            , avg_allowed as kennzahl_1
            , 0 as kennzahl_2
            , 0 as kennzahl_3
    ...
    $fantasy_score_allowed_mf = mysqli_query($con," 
        SELECT  
            'Avg. zugelassene Fantasy-Punkte: Mittelfeld' as headline
            , team_name as verein
            , avg_allowed as kennzahl_1
            , 0 as kennzahl_2
            , 0 as kennzahl_3
    ...
    $fantasy_score_allowed_st = mysqli_query($con," 
        SELECT  
            'Avg. zugelassene Fantasy-Punkte: Sturm' as headline
            , team_name as verein
            , avg_allowed as kennzahl_1
            , 0 as kennzahl_2
            , 0 as kennzahl_3
    ...
    foreach ($stats_to_iterate as $index => $element) {
        ...
        $top_fantasy =  mysqli_query($con,"     
            SELECT  
                '".strval($headline_here)."' as headline
    ...
    $top_forever =  mysqli_query($con,"     
            ...
            SELECT  
                'All-Time Fantasy-Punkte' as headline
    ...
    $top_season =   mysqli_query($con,"     
            ...
            SELECT  
                'Saison-Rekorde Fantasy-Punkte' as headline
                , display_name as name 
                , season_name
                , sum(ftsy_score) as kennzahl_1
                , sum(case when 1_ftsy_owner_id = '".$user_id."' then 1 else 0 end) as highlight_flg
