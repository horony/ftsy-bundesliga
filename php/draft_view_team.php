<?php
	// Zeige den bisherigen Draft eines beliebigen Fantasy Teams
	...
	$drafted_players = mysqli_query($con, "	SELECT 	display_name
													, teamname_code
													, team_logo
													, position_short
													, position_long
	...
	// Sortiere die gedrafteten Spiler nach Position und gebe sie entsprechend aus
