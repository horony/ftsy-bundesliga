...
$sql_result = mysqli_query($con, "	SELECT 		dof.round
							...
							, dpb.common_name
							, dpb.lastname
							, case 	when dpb.pick is null then '/images/icons/questionmarks.png' 
								else dpb.image_path 
								end as image_path
					...
					WHERE 		dof.pick BETWEEN (SELECT current_pick_no-5 FROM xa7580_db1.draft_meta) 
							AND (SELECT current_pick_no+4 FROM xa7580_db1.draft_meta)
